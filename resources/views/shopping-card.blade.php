                                            ...
                                            <div class="card h-100 border-0">
                                                <div class="card-body h-100">
                                                    ...
                                                    <p class="card-text text-danger">{{$item['product']->price}}
                                                        &#8381</p>
                                                    @if($item['product'] -> category ->supercategory -> supercategory_name === 'Одежда женская' or $item['product'] -> category -> supercategory -> supercategory_name === 'Одежда мужская')
                                                    <p class="card-text"><span
                                                                class="font-weight-bold">Размер: </span>{{$sizes->find($item['size'])->size}}
                                                    </p>
                                                    @endif
                                                </div>
                        ...
                        <div class="container">
                            ...
                            <section class="step">
                                ...
                                <div class="row justify-content-between" v-if="delivery === '1'">
                                    ...
                                    <div class="col-3" v-if="res < 1000">300 &#8381;</div>
