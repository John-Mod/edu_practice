...
<header>
    ...
    <div class="header-top">
        <p class="my-1 pb-1 text-muted">CYBER MONDAY 30% при покупке от 2500 руб.</p>
    </div>

    {{--Contacts--}}
    <div class="row bg-dark header-info">
        <div class="container py-1">
            <span class="col">89993332211</span>
            <span class="col pr-0">г. Томск, пл.Ленина, 1</span>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto justify-content-start pt-1 mt-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-title text-dark" href="/cooperation">СОТРУДНИЧЕСТВО</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="content container">
        <div class="row ">
            <div class="col">
                ...
                <div>
                    <a href="/contacts" class="col-content">Контакты</a>
                    <a href="/public_offer" class="col-content">Публичная оферта</a>
            ...
            <div class="col">
                ...
                <div>
                    ...
                    <a href="/faq" class="col-content">FAQ</a>
                </div>
            </div>
            <div class="col">
                <span class="col-title">Контакты</span>
                <div>
                    <span class="col-content">г.Томск, ул.Учебная 22а, ст1</span>
                    <span class="col-content">89993332211</span>
                    <span class="col-content">youryoga@gmail.com</span>
                </div>
            </div>
