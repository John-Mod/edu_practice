                        ...
                        <div class="product-body">
                            ...
                            <div class="availability row mt-1">
                                ...
                                <div class="col choose-input">
                                    @if($supercateg -> supercategory_name === 'Одежда женская' or $supercateg -> supercategory_name === 'Одежда мужская')
                                        <div class="row">
                                            <div class="col size">
                            ...
                            <div class="tab-pane fade" id="nav-delivery" role="tabpanel" aria-labelledby="nav-delivery-tab">
                                <div class="col">
                                    <div class="mt-3 mb-4">
                                        ...
                                        <p>Ближайшая дата: через 2-5 дней, 300 Р. При заказе от 1000 Р доставка бесплатная</p>
                                    </div>
                                    <div class="mt-3">
